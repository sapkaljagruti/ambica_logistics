...
class BranchMasterController {
    ...
    public function insert_record() {
        ...
        if (isset($_POST['email'])) {
            ...
            $ins = $this->model->insert($_POST['branch_name'], $_POST['branch_code'], $_POST['address'], $_POST['pincode'], $_POST['state'], $_POST['std_code'], $_POST['phone1'], $_POST['phone2'], $_POST['phone3'], $_POST['fax'], $_POST['mobile'], $_POST['manager_id'], $_POST['email']);
            if ($ins) {
    ...
    public function update($branch_id) {
        $branch = $this->model->get_branch($branch_id);
        if (isset($_POST['email'])) {
            $upd = $this->model->upd_branch($branch_id, $_POST['branch_name'], $_POST['branch_code'], $_POST['address'], $_POST['pincode'], $_POST['state'], $_POST['std_code'], $_POST['phone1'], $_POST['phone2'], $_POST['phone3'], $_POST['fax'], $_POST['mobile'], $_POST['manager_id'], $_POST['email']);
            if ($upd) {
                header("location:home.php?controller=branch&action=branches");
            }
        }
