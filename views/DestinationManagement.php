            ...
            <form role="form" action="" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputStation Name1">Station Name</label>
                  <input type="text" class="form-control" id="exampleInputStation Name1" name="station_name">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="exampleInputZone Branch1">Zone Branch</label>
                  <select class="form-control" id="exampleInputZone Branch1" name="zone_branch"> 
                      <option value="Zone Branch">Zone Branch</option>
                  </select>
                </div>
                <div class="form-group">
                  <label for="exampleInputPin1">Pin</label>
                  <input type="text" class="form-control" id="exampleInputPin1" name="pin">
                </div>  
                <div class="form-group">
                  <label for="exampleInputSTD1">STD</label>
                  <input type="text" class="form-control" id="exampleInputSTD1" name="std">
                </div>
                <div class="form-group">
