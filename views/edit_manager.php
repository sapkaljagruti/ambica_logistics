                ...
                if (isset($get)) {
                    while ($row = mysqli_fetch_assoc($get)) {
                        ...
                        <form class="form-horizontal" action="" method="post">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputName3" name="name" value="<?php echo $name; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="inputMobile3" name="mobile1" value="<?php echo $mobile1; ?>">
                            </div>
