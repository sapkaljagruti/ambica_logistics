            ...
            <form role="form" action="" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputGodown Name1">Godown Name</label>
                  <input type="text" class="form-control" id="exampleInputGodown Name1" name="godown_name">
                </div>
                <div class="form-group">
                  <label for="exampleInputCode1">Code</label>
                  <input type="text" class="form-control" id="exampleInputCode1" name="code">
                </div>
                <div class="form-group">
                  <label for="exampleInputUnder Branch1">Under Branch</label>
                  <select class="form-control" id="exampleInputUnder Branch1" name="under_branch"> 
                      <option value="Select Branch">Select Branch</option>
                  </select>
                </div>
                <div class="form-group">
                  <label for="exampleInputUnder Godown1">Under Godown</label>
                  <select class="form-control" id="exampleInputUnder Godown1" name="under_godown"> 
                      <option value="Select Godown">Select Godown</option>
                  </select>
                </div>  
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="exampleInputPhone_no1">Phone_no</label>
                  <input type="text" class="form-control" id="exampleInputPhone_no1" name="phone_no">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail_id1">Email_id</label>
                  <input type="text" class="form-control" id="exampleInputEmail_id1" name="email_id">
                </div>    
              </div>
              <!-- /.box-body -->
