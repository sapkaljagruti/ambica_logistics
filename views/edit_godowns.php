                        ...
                        <form class="form-horizontal" action="" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" id="inputUnder branch3" name="branch_id">
                                            <option value = "$row['id']">branch_name</option>
                                            <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea row="2" cols="40" class="form-control" id="inputAddress3" name="address" value=<?php echo $address; ?>></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
