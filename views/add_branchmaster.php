            ...
            <form role="form" action="" method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="branch_name" class="form-control" id="exampleInputBranch Name1" name="branch_name">
                </div>
                <div class="form-group">
                  <label for="exampleInputBranch Code1">Branch Code</label>
                  <input type="branch_code" class="form-control" id="exampleInputBranch Code1" name="branch_code">
                </div>
                <div class="form-group">
                  <label for="exampleInputAddress1">Address</label>
                  <textarea rows="4" cols="50" class="form-control" id="exampleInputAddress1" name="address"> </textarea>
                </div>
                <div class="form-group">
                  <label for="exampleInputPincode1">Pincode</label>
                  <input type="pincode" class="form-control" id="exampleInputPincode1" name="pincode">
                </div>  
                 <div class="form-group">
                  <label for="exampleInputState1">State</label>
                  <input type="state" class="form-control" id="exampleInputState1" name="state">
                </div>
                <div class="form-group">
                  <label for="exampleInputSTD Code1">STD Code</label>
                  <input type="std_code" class="form-control" id="exampleInputSTD Code1" name="std_code">
                </div>
                <div class="form-group">
                  <label for="exampleInputPhone11">Phone1</label>
                  <input type="phone1" class="form-control" id="exampleInputPhone11" name="phone1">
                </div>
                <div class="form-group">
                  <label for="exampleInputPhone21">Phone2</label>
                  <input type="phone2" class="form-control" id="exampleInputPhone21" name="phone2">
                </div>
                <div class="form-group">
                  <label for="exampleInputPhone31">Phone3</label>
                  <input type="phone3" class="form-control" id="exampleInputPhone31" name="phone3">
                </div>
                <div class="form-group">
                  <label for="exampleInputFax1">Fax</label>
                  <input type="fax" class="form-control" id="exampleInputFax1" name="fax">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="manager" class="form-control" id="exampleInputManager1" name="manager">
                </div>
                <div class="form-group">
