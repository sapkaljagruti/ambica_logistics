                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-info">
                                ...
                                <form class="form-horizontal" action="" method="post">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="InputBranch Name3">Branch Name</label>
                                        ...
                                        <div class="form-group">
                                            <label for="InputBranch Code3">Branch Code</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea rows="4" cols="50" class="form-control" id="InputAddress3" name="address"> </textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="InputPincode3">Pincode</label>
                                        ...
                                        <div class="form-group">
                                            <label for="InputSTD Code3">STD Code</label>
                                        ...
                                        <div class="form-group">
                                            <label for="InputPhone13">Phone1</label>
                                        ...
                                        <div class="form-group">
                                            <label for="InputPhone23">Phone2</label>
                                        ...
                                        <div class="form-group">
                                            <label for="InputPhone33">Phone3</label>
                                        ...
                                        <div class="form-group">
                                            <label for="InputManager3">Manager</label>
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <button type="submit" class="btn btn-info pull-right" name="Save" value="Save">Save</button>
                                    </div>
                                    <!-- /.box-footer -->
                                </form>
                            </div>
